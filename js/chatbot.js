...
const getLocalResponse = (userInput) => {
    ...
    { keywords: ["tư vấn", "tư vấn học tập", "học tập", "khó khăn"], reply: "Bạn đang gặp khó khăn với môn nào? Hoặc bạn muốn biết thông tin về môn học nào cụ thể? Hãy cho tôi biết nhé!" },
    ...
    {
        keywords: ["làm sao biết đăng ký thành công", "đăng ký môn học thành công chưa", "kiểm tra đăng ký môn học"],
    ...
    {
        keywords: ["quy định điểm danh", "điểm chuyên cần", "quy định vắng mặt", "điểm chuyên cần môn học"],
    ...
    {
        keywords: ["chính sách thi lại", "học cải thiện", "quy định thi lại", "thi lại học phần", "cải thiện điểm"],
    ...
    {
        keywords: ["điều kiện xét học bổng", "học bổng khuyến khích học tập", "xét học bổng"],
    ...
    {
        keywords: ["chính sách đạo văn", "gian lận thi cử", "quy định đạo văn", "xử lý gian lận"],
    ...
    {
        "keywords": ["trường có hỗ trợ tìm kiếm chỗ thực tập không", "hỗ trợ thực tập", "tìm chỗ thực tập", "cơ hội thực tập", "sinh viên có được hỗ trợ thực tập không"],
    ...
    {
        "keywords": ["dự án nghiên cứu tiêu biểu của sinh viên", "đồ án môn học tiêu biểu của sinh viên", "dự án nghiên cứu sinh viên CNTT", "đồ án sinh viên cntt"],
    ...
    {
        "keywords": ["liên hệ phòng ban", "hỏi về học phí", "cấp lại thẻ sinh viên", "hỏi về ký túc xá", "hỏi về bằng cấp", "liên hệ về vấn đề", "phòng ban nào để hỏi"],
    ...
    },
    {
     ...
     {
        "keywords": ["phòng máy tính của khoa", "phòng máy tính của trường", "vị trí phòng máy tính", "máy tính trường"],
